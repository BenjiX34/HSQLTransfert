...
public class BankingTest {
	...
	public void successfulTransfer() throws Exception {
        ...
        public void negativeBalance() throws Exception {
            int fromCustomer = 1;
            int toCustomer = 0;
            myDAO.bankTransferTransaction(fromCustomer, toCustomer, 51);
        
        }

        @Test(expected=SQLException.class)
        public void nonExistingCreditAccount() throws Exception{
            int fromCustomer = 0;
            int toCustomer = 2;
            myDAO.bankTransferTransaction(fromCustomer, toCustomer, 50);
        }
        
        
        @Test(expected=SQLException.class)
        public void nonExistingDebitAccount() throws Exception{
            int fromCustomer = 2;
            int toCustomer = 0;
            myDAO.bankTransferTransaction(fromCustomer, toCustomer, 50);
        }
